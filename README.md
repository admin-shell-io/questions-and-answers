...
**How shall a link to a website be entered in an AAS, as File or as ReferenceElement object?** <a id="id2"></a><!-- ID: 2 -->
...
**If the same properties are use in several submodels, shall they also be entered several times or shall they be referenced?** <a id="id5"></a>a id="id23"></a><!-- ID: 5, 23 -->
...
**How to use physical units for quantifiable properties?** <a id="id7"></a><a id="id20"></a><!-- ID: 7, 20 -->
...
**What shall be entered for the semanticId attribute if a related concept description does not exist in eCl@ss or IEC CDD?** <a id="id3"></a><!-- ID: 3 -->
...
**How shall the eCl@ss group “Zusatzdokumentation (e.g. IRDI 0173-1#02-ADN464#..)” be used for documentation?** <a id="id8"></a><!-- ID: 8 -->

Please use the submodel template based on VDI 2770 for documentation instead. It will be released soon.
(Updated: 2020-08-14)

**How to treat values of Properties with values in multiple languages?** <a id="id9"></a><!-- ID: 9 -->
...
**How shall a document be handled which includes different content according to VDI 2770 and the related DocumentClassIDs?** <a id="id10"></a><!-- ID: 10 -->
...
**Which names are already defined for important submodels?** <a id="id12"></a><a id="id21"></a><a id="id24"></a><!-- ID: 12, 21, 24 -->
...
**How to store certificates and conformance declarations within AAS/Submodels?** <a id="id13"></a><!-- ID: 13 -->
...
**Which mechanisms can be used to structure complex data?** <a id="id15"></a><!-- ID: 15 -->
...
**Where are examples of AAS available?** <a id="id16"></a><!-- ID: 16 -->

Examples of several suppliers are found at: http://admin-shell-io.com/samples/ 
(Answered: 2020-08-13)

**What are best practices for creating custom IRI identifiers for generic concepts.** <a id="id18"></a><!-- ID: 18 -->
...
**Which submodel shall contain the serial number of a device?** <a id="id23"></a><!-- ID: 23 -->
...
**How to refer to semantic concepts of existing standards like VDI 2770 properties or OPC UA companion specifications (e.g. “Serial number” property from OPC UA DI companion spec)?** <a id="id27"></a><a id="id28"></a><!-- ID: 27, 28 -->
...
**How is the relation between idShort, shortName and preferredName for a submodel element and the related concept description?** <a id="id30"></a><!-- ID: 30 -->
...
**Where shall images (products or icons) of an asset be stored, e.g. for the use in dashboards?** <a id="id31"></a><!-- ID: 31 -->
...
**How shall properties be entered which are defined both in eCl@ss and in CDD?** <a id="id34"></a><!-- ID: 34 -->
...
**Is the following IRI-based ID with a query parameter valid “http://vendor.com/suffx?a=abc&b=xyz”?** <a id="id38"></a><!-- ID: 38 -->

Yes, this is a valid ID. (Answered: 2020-09-21)

**Are semanticID(s) optional or mandatory?** <a id="id40"></a><!-- ID: 40 -->
...
**Can semantic ID(s) be used without defining a concept description within the AAS package?** <a id="id41"></a><!-- ID: 41 -->
